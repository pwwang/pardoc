...
..
   ...
   ..
      ...
      ..
         ...
         parsed = google\ *parser.parse(docstring)
         pretty(parsed, print*\ =True)
...
The ``Parsed`` is an ordered dictionary (\ ``OrderedDiot``\ ) from `\ ``diot`` <https://github.com/pwwang/diot>`_\ , which
